...
public class ElectricGoldRefinery extends SlimefunItem implements InventoryBlock, EnergyNetComponent {
  ...
  public ElectricGoldRefinery() {
    super(Items.machines, Items.ELECTRIC_GOLD_REFINERY, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
  ...
  protected MachineRecipe findNextRecipe(BlockMenu menu, String g) {
